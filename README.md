...
marmalader - RFID Jammer

https://www.esp32.com/viewtopic.php?t=27725

https://docs.espressif.com/projects/esp-idf/en/release-v5.2/esp32/api-guides/RF_calibration.html
https://github.com/espressif/esp-idf/tree/master/examples/phy/cert_test



For console interaction must install tinyusb stack:
...
(1)     CDC Channel Count (NEW)
(512)   CDC FIFO size of RX channel (NEW)
(512)   CDC FIFO size of TX channel (NEW)
